package com.azamovhudstc.logosmart.data.local.shp

import android.content.Context
import android.content.Context.MODE_PRIVATE
import android.content.SharedPreferences
import com.azamovhudstc.logosmart.utils.enums.CurrentScreenEnum
import com.azamovhudstc.logosmart.utils.enums.LanguageType
import com.azamovhudstc.logosmart.utils.screenCurrentEnum
import com.azamovhudstc.logosmart.utils.screenEnum
...
class AppReference @Inject constructor(
    ...
    var currentScreenEnum: CurrentScreenEnum
        get() = sharedPref.getString("current_language", CurrentScreenEnum.REGISTER.name)!!.screenCurrentEnum()
        set(value) {
